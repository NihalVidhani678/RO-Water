...
class CustomerScreen extends StatefulWidget {
  ...
  CustomerScreen({required this.usercode});
...
class _CustomerScreenState extends State<CustomerScreen> {
  ...
  getCustomerDetails() async {
    Customer customer = await dbHandler.getCustomer(widget.usercode);
    setState(() {
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            GestureDetector(
              onTap: () async {
                DBHandler dbHandler = new DBHandler();
                bool response = await dbHandler.deleteCustomer(widget.usercode);
                if (response) {
